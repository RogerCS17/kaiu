...
class KaijuDrawer extends StatelessWidget {
  ...
  KaijuDrawer({required this.kaiju});
      ...
      child: ListView(
        children: [    
          ...
          DrawerHeader(
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                ...
                image: AssetImage("assets/bemular_drawer.webp"),
                fit: BoxFit.cover,
              ),
            ),
            child: Align(
          ...
          ListTile(
            ...
            title: KaijuOptionDrawer(color: colorFromHex(kaiju.colorHex), text: 'Alias Oficial: ${kaiju.aliasOf}',),
          ),
          
          // Título de la altura del enemigo.
          ListTile(
            title: KaijuOptionDrawer(color: Colors.orange, text: 'Altura: ${kaiju.height}',),
            
          ),
         
          // Título del peso del enemigo.
          ListTile(
            title: KaijuOptionDrawer(color: Colors.green, text: 'Peso: ${kaiju.weight}',),
          ),
          
          // Título del planeta de origen del enemigo.
          ListTile(
            title: KaijuOptionDrawer(color: Colors.lightBlueAccent, text: 'Planeta de Origen: ${kaiju.planet}',),
            // onTap: () {
          ...
          ListTile(
            title: KaijuOptionDrawer(color: Colors.red, text: 'Habilidades', optionColor: Configure.ultraOption, ),
            onTap: () {
          ...
          ListTile(
            title: KaijuOptionDrawer(color: Colors.purple, text: 'Debilidades', optionColor: Configure.ultraOption ),
            onTap: () {
          ...
          ListTile(
            title: KaijuOptionDrawer(color: const Color.fromARGB(255, 252, 227, 2), text: 'Galería Online', optionColor: Configure.ultraOption ),
            onTap: () {
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Configure.ultraRed.withOpacity(0.6),
                      elevation: 5.0,
                    ),
                    onPressed: (){
